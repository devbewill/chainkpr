        ...
        <div className="mt-8 grid items-center grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-4 text-base">
            <h2 className="text-sm font-semibold text-primary uppercase">
              Your tailored processes
            </h2>
            <h2 className="mt-2 text-xl md:mb-8 lg:text-3xl">
              Managing diverse data flows and ensuring trust among stakeholders
            ...
            <p>
              ...
              their unique workflow while ensuring trust among stakeholders. A
              one-size-fits-all approach to business orchestration is no longer
              sufficient.
            </p>

            <p>
              That's why we empower you to create your own blockchain-based
              workflow, making your processes management among different
              stakeholders easy, flexible and secure.
            </p>
          </div>
